...
config :easypodcasts, EasypodcastsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "u73ErqFHfQe2OJgeLPeNu+vcF6Ai6YE8SqhQtAPtD0sDFzwE+JN+nZWfJZpL2ZUJ",
  watchers: [
    # Start the esbuild watcher by calling Esbuild.install_and_run(:default, args)
    esbuild: {Esbuild, :install_and_run, [:default, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:default, ~w(--watch)]}
  ],
  phoenix_profiler: [server: Easypodcasts.Profiler]
...
config :easypodcasts, EasypodcastsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/easypodcasts_web/(live|views)/.*(ex)$",
      ~r"lib/easypodcasts_web/templates/.*(eex)$"
    ]
  ]
