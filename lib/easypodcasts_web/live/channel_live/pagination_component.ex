defmodule EasypodcastsWeb.PaginationComponent do
  ...
  def pagination(
    ...
    <nav class={nav_classes(is_top)}>
      <%= live_redirect to: get_route(socket, route, action, object_id, search, page_number - 1 ), class: "block bg-white border border-gray-300 text-gray-500 hover:bg-gray-100 hover:text-gray-700 ml-0 rounded-l-lg leading-tight py-2 px-3 #{if page_number == 1, do: "pointer-events-none text-gray-600"}" do %>
      ...
      <%= live_redirect to: get_route(socket, route, action, object_id, search, page_number + 1), class: "block bg-white border border-gray-300 text-gray-500 hover:bg-gray-100 hover:text-gray-700 rounded-r-lg leading-tight py-2 px-3 #{if page_number == total_pages, do: "pointer-events-none text-gray-600"}" do %>
